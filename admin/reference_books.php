...
<head>
    ...
    <title>Reference Books List</title>
    <link rel="stylesheet" href="./style.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="./reference_books.css?v=<?php echo time(); ?>">
...
<body>
    <div class="wrapper">
        <?php
            include "navbar.php";
            include "./reference_books_db.php";
        ?>
    
        <section class="homepage-bodyy">
            <div class="boxx">
                <h1>Reference Books List</h1>
                <hr>
                    ...
                    <div class="table_container">
                        ...
                        <?php
                            if(isset($_POST['delete'])){
                                ...
                                mysqli_query($conn,"DELETE FROM `reference_book_upload` WHERE `book_id` = $book_id");
                        ...
                        <?php
                            if(isset($_POST['books_search'])) {
                                $check_book_name = mysqli_query($conn, "SELECT * FROM `reference_book_upload` WHERE `book_name` LIKE '%$_POST[search]%' ORDER BY `book_name` ASC");
                                ...
                                $books_request_database = mysqli_query($conn,"SELECT * FROM `reference_book_upload` ORDER BY `reference_book_upload`.`book_name` ASC ;");

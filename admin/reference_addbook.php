...
<head>
    ...
    <title>Reference Books Upload</title>
    <link rel="stylesheet" href="./style.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="./reference_addbook.css?v=<?php echo time(); ?>">
                    ...
                    <div class="success">
                        <?php
                                if(isset($_POST['submit'])) {
                                    ...
                                    $push_information_database = "INSERT INTO `reference_book_upload`(`book_id`, `book_name`, `book_authors`, `book_edition`, `book_status`, `book_quantity`, `department`, `book_link`) 
                                    ...
                                    if(mysqli_query($conn, $push_information_database)) {
                                        echo "<h4>Book: ($book_name)successfully inserted into the Reference Books database.</h4>";
                                    } else {

...
<head>
    ...
    <title>Download Books Upload</title>
    <link rel="stylesheet" href="./style.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="./download_addbook.css?v=<?php echo time(); ?>">
...
<body>
    <div class="wrapper">
        ...
        <section class="homepage-bodyy">
            <div class="boxx">
                <h1>Downloadable Books Upload</h1>
                <hr>
                <form action="" method="post">
                        ...
                        <input type="text" name="book_edition" id="book_edition" placeholder="3rd">
                    ...
                    <div class="success">
                        <?php
                                if(isset($_POST['submit'])) {
                                    ...
                                    $push_information_database = "INSERT INTO `download_book_upload`(`book_id`, `book_name`, `book_authors`, `book_edition`, `book_status`, `book_quantity`, `department`, `book_link`) 
                                    ...
                                    if(mysqli_query($conn, $push_information_database)) {
                                        echo "<h4>Book: ($book_name)successfully inserted into the Downloadable Books database.</h4>";
                                    } else {

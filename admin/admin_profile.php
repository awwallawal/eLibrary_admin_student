...
<head>
    ...
    <link rel="stylesheet" href="./admin_profile.css?v=<?php echo time(); ?>">
        ...
        <section class="profile_body">
            <div class="profile_box">
                ...
                <div class="profile_wrapper">
                    <?php 
                      $get_user_login_info = mysqli_query($conn,"SELECT * FROM `admin_info` WHERE username = '$_SESSION[login_user]';");
                    ?>
                    ...
                    <?php
                        ...
                        echo "<div><img src = '../admin/image/". $_SESSION['picture']."' alt='Student Image' style='width: 8rem; height: 8rem;'/></div>";
                    ?>
                    </div>

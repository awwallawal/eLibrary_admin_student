...
<header>
    ...
    <nav>
        <ul>
            ...
            <li><a href="./addbook.php">Books Upload</a></li>
            <li><a href="./admin_student_info.php">Student-Information</a></li>
            <li><a href="./book_request_list.php">Books Request List</a></li>
            <li><a href="./feedback.php">Feedback</a></li>
        </ul>
    </nav>
    <p style="display: flex; justify-content:center; align-items:flex-end; gap:0.7rem;"> 
    <?php echo "<img src='../admin/image/" . $_SESSION['picture'] . "' alt='Staff Image' style='width: 3rem; height: 3rem; border-radius: 50%;'>" . $_SESSION['login_user']; ?> 
    </p>

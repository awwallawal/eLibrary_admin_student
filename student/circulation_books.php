                        ...
                        <?php
                            if(isset($_POST['request'])){
                                if(isset($_SESSION['login_user'])){
                                    ...
                                    $book_request_page = "./book_request.php";
                                    ...
                                    echo "<p>" . $book_name . " successfully requested. Check your <a href='" . $book_request_page . "' target='_blank'>books requested page</a> for approval status.</p>";
                                ?>
                                    <script>
                            ...
                            if(isset($_POST['books_search'])) {
                                ...
                                if(mysqli_num_rows($check_book_name)==0){
                                    ...
                                    while($row = mysqli_fetch_assoc($check_book_name)) {
                                                ...
                                                echo "<input type='hidden' name='book_authors' value='" . $row['book_authors'] . "' style='width: 100%;'>";
                                                echo "<button type='submit' name='request' style='width: 100%; background-color: green; font-size: 1rem;'>Request</button>";
                                                echo "</form>";
                                                echo "</td>";
                                                // echo "<td style='width: 5%;'>";
                                                // echo "<form method='post' action='' style='width: 100%;'>";

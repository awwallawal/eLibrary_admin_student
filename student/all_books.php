...
<head>
    ...
    <link rel="stylesheet" href="./all_books.css?v=<?php echo time(); ?>">
                    ...
                    <div class="table_container">
                        ...
                        <?php
                            if(isset($_POST['delete'])){
                                ...
                                mysqli_query($conn,"DELETE FROM `book_upload` WHERE `book_id` = $book_id");
                        ...
                        <?php
                            if(isset($_POST['books_search'])) {
                                $check_book_name = mysqli_query($conn, "SELECT * FROM `book_upload` WHERE `book_name` LIKE '%$_POST[search]%' ORDER BY `book_name` ASC");
                                ...
                                $books_request_database = mysqli_query($conn,"SELECT * FROM `book_upload` ORDER BY `book_upload`.`book_name` ASC ;");

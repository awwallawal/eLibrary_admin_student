    ...
    <div class="wrapper">
        ...
        <section class="student-bodyyy">
            ...
            <div class="form-logo"><img src="./image/school_logo.png" alt=""></div>
                <form action="./student_login_db.php" method="post">
                <p>
                ...
                <p class="register">Don't have an account? <span> <a href="./registration_page.php" target="_blank">Sign Up</a></span></p>
                <p><a href="./update_password.php" target="_blank">Forgot password?</a></p>
